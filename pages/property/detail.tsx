						...
						<Stack className={'property-info-config'}>
								...
								<Stack className={'left-box'}>
									...
									<Stack className={'bottom-box'}>
										<Stack className="option">
											<img src="/img/icons/diriven.png" alt="" height="17px" width="17px" />
											<span>{property?.propertyDrivenDistance} km</span>
										</Stack>
										<Stack className="option">
											<img src="/img/icons/transmission.png" alt="" height="17px" width="17px" />
											<span>{property?.propertyTransmission} </span>
										</Stack>
										<Stack className="option">
											<img src="/img/icons/fuel.png" alt="" height="17px" width="17px" />
											<span>{property?.propertyFuel} </span>
										</Stack>

										<Stack className="option">
											<img src="/img/icons/year.png" alt="" height="17px" width="17px" />
							...
							<Stack className={'images'}>
								<Stack className={'main-image'}>
									<img src={slideImage ? `${REACT_APP_API_URL}/${slideImage}` : ''} alt={'Loading...'} />
								</Stack>
							...
							<Stack className={'left-config'}>
								<Stack className={'options-config'}>
									<Stack className={'option'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{property?.propertyDrivenDistance} km</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
									...
									<Stack className={'option'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{property?.propertyManufacturedYear} </Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img src="/img/icons/cartype.svg" alt="" height="17px" width="17px" />
										</Stack>
										<Stack className={'option-includes'}>
									...
									<Stack className={'bottom'}>
										...
										<Stack className={'info-box'}>
											<Stack className={'left'}>
												...
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Mileage</Typography>
													<Typography className={'data'}>{property?.propertyDrivenDistance} km</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Transmission</Typography>
											...
											<Stack className={'right'}>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Year Made</Typography>
													<Typography className={'data'}>{property?.propertyManufacturedYear}</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Property Type</Typography>
								...
								<Stack className={'floor-plans-config'}>
									...
									<Stack className={'image-box'}>
										{property?.propertyOptions?.find((option) => option === PropertyOptions.LEATHER_SEATS) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/leatherseat.svg" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.LEATHER_SEATS)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.HEATED_SEATS) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/heatedseat.png" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.HEATED_SEATS)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.COOLING_SEATS) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/coolingseat.png" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.COOLING_SEATS)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.HEATED_STEERING_WHEEL) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/heatedhandle.png" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.HEATED_STEERING_WHEEL)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.NAVIGATION) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/navigation.svg" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.NAVIGATION)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.CRUISE_CONTROL) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/cruzecontroll.png" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.CRUISE_CONTROL)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.PARKING_SENSORS) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/parkingsensor.webp" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.PARKING_SENSORS)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.REAR_CAMERA) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/rearecamera.webp" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.REAR_CAMERA)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.EMERGENCY_BRAKING) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/braking.png" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.EMERGENCY_BRAKING)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.AROUND_VIEW) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/camera.png" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.AROUND_VIEW)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
										...
										{property?.propertyOptions?.find((option) => option === PropertyOptions.LINE_DEPARTURE_WARNING) ? (
											<Box className="box-container">
												<Box className="icon-box">
													<img src="/img/property/linewarning.png" alt="" />
												</Box>
												<Typography>
													{property?.propertyOptions
														?.find((option) => option === PropertyOptions.LINE_DEPARTURE_WARNING)
														?.replace(/_/g, ' ')}
												</Typography>
											</Box>
										) : (
