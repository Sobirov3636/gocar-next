...
const Faq = ({ initialFaq, ...props }: any) => {
	...
	const [faqCategory, setFaqCategory] = useState<FaqCategory>(FaqCategory.PROPERTY);
		...
		return (
			<Stack className={'faq-content'}>
				<Box className={'categories'} component={'div'}>
					<div
						className={faqCategory === FaqCategory.PROPERTY ? 'active' : ''}
						onClick={() => {
					...
					<div
						className={faqCategory === FaqCategory.DEALERS ? 'active' : ''}
						onClick={() => {
							changeCategoryHandler(FaqCategory.DEALERS);
						}}
					>
						For Dealers
					</div>
